#!/bin/sh -ue
#
# This script generates the release notes "car" for a specific release tag.
...
cat <<EOF
car ${version} supports X and Y and notably fixes Z
...
## Thank you
car ${version} was possible thanks to the following contributors:
